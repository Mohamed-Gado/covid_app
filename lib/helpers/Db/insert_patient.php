...
$queryst = "INSERT INTO symptoms (id,bloodType,currentLocation,currentLati,four,five,six,seven,eight,nine,ten,eleven,twelve,thirteen,fourteen) VALUES('".$id."','".$one."','".$two."','".$three."','".$four."','".$five."','".$six."','".$seven."','".$eight."','".$nine."','".$ten."','".$eleven."','".$twelve."','".$thirteen."','".$fourteen."') ON DUPLICATE KEY UPDATE one='".$one."', two='".$two."', three='".$three."', four='".$four."', five='".$five."', six='".$six."',seven='".$seven."',eight='".$eight."', nine='".$nine."',ten='".$ten."',eleven='".$eleven."',twelve='".$twelve."',thirteen='".$thirteen."',fourteen='".$fourteen."'";
